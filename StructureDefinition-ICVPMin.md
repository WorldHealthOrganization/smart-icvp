...
| Active as of 2026-09-23 | *Computable Name*:ICVPMin |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.icvp|current/StructureDefinition/StructureDefinition-ICVPMin.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "ICVPMin.d",
      "short" : "Issuance date",
      "definition" : "Date on which the ICVP was issued by the issuing authority.",
      "comment" : "Date of issuance for the certificate; the capture date is not the same as the date of vaccination or the date of birth.",
      "requirements" : "SHALL carry the date on which the ICVP was issued by the issuing authority. This date supports validity checks, certificate age assessment, and interpretation of time-bound vaccine recommendations.",
      "min" : 1,
      "max" : "1",
      "type" : [{
        "code" : "date"
