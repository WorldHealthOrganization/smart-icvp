...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "http://smart.who.int/icvp/Requirements/ICVPRequirements"
  },
  {
  ...
  },
  {
    ...
    "valueString" : "ICVPRequirements"
  },
  {
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
    "valueString" : "Digital ICVP — Core Data Element Requirements"
  },
  {
  ...
  },
  {
    ...
    "valueMarkdown" : "Provide a machine-readable, traceable statement of the regulatory and normative requirements for the Digital ICVP, supporting conformance assessment of the ICVPMin logical model, profiles, value sets and decision-support logic defined in this IG."
  },
  {
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.copyright",
    "valueMarkdown" : "© World Health Organization, 2026. Licensed under CC-BY-SA-3.0-IGO."
  },
  {
    "extension" : [{
    ...
    },
    {
      ...
      "valueString" : "No departure from the Model"
    },
    {
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Three logical sections"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "A Digital ICVP SHALL represent all three sections of the Model ICVP: (1) information about the recipient (ICVPMin.n, dob, s, nt, id, dt, gn — ICVP.A9.DE.1–A9.DE.10); (2) list of vaccine(s) or prophylaxis(es) administered (ICVPMin.vx / ICVPMinVaccineDetails — ICVP.C5.DE.11–C5.DE.19); (3) basic information to ascertain validity (ICVPMin.v and HCERT envelope — ICVP.D5.DE.20–D5.DE.27)."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6; WHO Coexistence document"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Individuality of the certificate"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "A Digital ICVP instance SHALL describe exactly one recipient; bundling multiple recipients in a single signed payload is NOT PERMITTED. Each signed ICVPMin payload SHALL correspond to exactly one administered dose of one vaccine or prophylaxis product. Separate certificates SHALL be issued for children and for each administration."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 §7; WHO Coexistence document §260306"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Language of completion"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "All required string-typed fields (e.g. ICVPMin.n, gn, vaccine details) SHALL be present in English or French. Implementations MAY carry parallel translations in additional languages; translations SHALL NOT replace the English or French representation."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 §5"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "No amendment or erasure"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Once signed, the payload SHALL NOT be modified. Any required correction SHALL be issued as a new certificate. This is enforced through the cryptographic integrity check on the HCERT payload."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 §6"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "WHO-approved vaccine or prophylaxis"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Naming of the issuer"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Wet-ink artefacts not applicable"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Recipient signature, guardian signature, clinician signature and official centre stamp apply only to the non-digital format and SHALL NOT be carried in the Digital ICVP payload. These are replaced by the HCERT cryptographic signature (REQ-DE-25)."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "WHO Coexistence document, Table 2"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "The Digital ICVP profiled in this IG SHALL be used only for certificates issued on or after 19 September 2025, and only for State Parties for which the 2024 amendments to the Model ICVP are in force."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "WHO Coexistence document, citing op. paragraph 2.(2) of WHA77.17"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Selective disclosure"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHOULD"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPSD"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Name of the recipient (ICVP.A9.DE.1 → ICVPMin.n)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "The Digital ICVP SHALL carry the full name of the recipient of the vaccine or prophylaxis, transcribed usually from the identity document the recipient intends to use for travel. The recipient is the natural person who actually received the vaccine (subject). The issuer SHALL record the name in the same form and order as it appears in the name field of the identity document used for travel. Coding: ICVP.Core #ICVP.A9.DE.1; LOINC 87226-7. Cardinality 1..1, type string, Required."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 Model ICVP; WHO Coexistence Table 2"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.n"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Date of birth (ICVP.A9.DE.2 → ICVPMin.dob)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.dob"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Sex (ICVP.A9.DE.3 → ICVPMin.s)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "The Digital ICVP SHALL record the sex of the recipient. Bound (extensible) to FHIR AdministrativeGender (male/female/other/unknown) via the mappings defined in the ICVP.Core ConceptMap. Usually the value corresponds to the sex indicated on the identity document; values that do not map directly (e.g. 'X' on some passports) MAY be extended or mapped to an existing permissible value. For interoperability, extended values not in the core value set SHALL be mapped to 'unknown' (ICVP.A9.DE.7). Coding: ICVP.Core #ICVP.A9.DE.3. Cardinality 1..1, type code, Required."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 Model ICVP; WHO Coexistence Table 2; ICVP Core Data Dictionary"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.s"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Nationality (ICVP.A9.DE.8 → ICVPMin.nt)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.nt"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "National identification document (ICVP.A9.DE.9 → ICVPMin.id + ICVPMin.dt)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHOULD"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "The Digital ICVP MAY carry an identifier from an official national identity document (e.g. national ID card, passport). Inclusion is governed by the policy of the issuing State Party. The Coexistence document endorses this element for identity binding at border control ('inspection of the ICVP vis-à-vis the national identification document, if applicable'), so issuers SHOULD populate it wherever operationally feasible. To resolve the Model ICVP ambiguity (footnote 23) between document number and document type, the IG supports both: id (0..1, string — document number) and dt (0..1, code — document type bound to HL7 v2 $identifierTypeVS, extensible). Implementations SHOULD populate both where available, and SHALL ensure any identifier carried complies with the data-protection regime of the issuing State Party (IHR Article 45). Coding: ICVP.Core #ICVP.A9.DE.9; LOINC 76435-7. Optional / If applicable."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 Model ICVP; IHR Article 45; WHO Coexistence Table 2 and footnote 23; Coexistence 'Individual issuance' validity criterion"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.dt"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Name of the parent or guardian (ICVP.A9.DE.10 → ICVPMin.gn)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMin#ICVPMin.gn"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Vaccine or prophylaxis (ICVP.C5.DE.11 → ICVPMinVaccineDetails.vp)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Name of disease or condition — derived (ICVP.C5.DE.12)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "ICVP.C5.DE.12 (name of disease or condition) is NOT independently populated in ICVPMinVaccineDetails. Verifiers SHALL derive it deterministically from vp via the ICVP Product Catalogue. Issuers MAY display the derived value on the human-readable view but SHALL NOT carry it in the signed payload."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "WHO Coexistence footnotes 25–27; ICVP Core Data Dictionary validation rule 'Must correspond to the disease targeted by the selected vaccine or prophylaxis product'"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/ValueSet/ICVPProductIds"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Date of vaccination (ICVP.C5.DE.13 → ICVPMinVaccineDetails.dv)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Name of supervising clinician (ICVP.C5.DE.14 → ICVPMinVaccineDetails.cn)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "MAY"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Issuing authority (ICVP.C5.DE.15 → ICVPMinVaccineDetails.is)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHOULD"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Manufacturer of vaccine or prophylaxis — derived (ICVP.C5.DE.16)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "ICVP.C5.DE.16 (manufacturer) is NOT independently populated in ICVPMinVaccineDetails. It is derived at verification time from vp via the ICVP Product Catalogue. Issuers MAY display the derived manufacturer on the human-readable view but SHALL NOT carry it in the signed payload."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "WHO Coexistence footnote 27"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/ValueSet/ICVPProductIds"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Batch number (ICVP.C5.DE.17 → ICVPMinVaccineDetails.bo)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Batch number (string) — collapsed (ICVP.C5.DE.18)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "ICVP.C5.DE.18 (batch number, string representation) is collapsed into the single field bo (REQ-DE-17) in ICVPMinVaccineDetails."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "ICVP Core Data Dictionary"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.satisfiedBy",
      "valueUrl" : "http://smart.who.int/icvp/StructureDefinition/ICVPMinVaccineDetails#ICVPMinVaccineDetails.bo"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Batch number (coded) — collapsed / out of scope (ICVP.C5.DE.19)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "ICVP.C5.DE.19 (batch number, coded representation) is collapsed into bo (REQ-DE-17). Coded batch representations are out of scope for the minimal HCERT payload."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "ICVP Core Data Dictionary"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Certificate valid from (ICVP.D5.DE.20)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Certificate valid until — selector (ICVP.D5.DE.21)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 6 Model ICVP; WHO Coexistence Table 2 and footnote 29"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Certificate valid until — lifetime variant (ICVP.D5.DE.22)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Used when the vaccine confers lifelong protection. Per Coexistence footnote 29 and Annex 7 §2.(a).(iii), one full dose of yellow-fever vaccine confers lifelong protection; the value SHALL be encoded as the literal string 'life of person vaccinated' (English) or 'vie entière du sujet vacciné' (French), in conformance with REQ-CC-04. No other free-text values are permitted. Coding: ICVP.Core #ICVP.D5.DE.22. Type string."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "IHR (2005) Annex 7 §2.(a).(iii); WHO Coexistence footnote 29"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Certificate valid until — bounded variant (ICVP.D5.DE.23)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Standard text following the Annex 6 table (ICVP.D5.DE.24)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Cryptographic signature of the issuer (ICVP.D5.DE.25)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Key identifier for signature verification (ICVP.D5.DE.26)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "The Digital ICVP SHALL carry a key identifier that allows the verifier to locate the issuer's public key in the GDHCN trust list. The identifier SHALL be resolvable to a participant in the SMART Trust ValueSet-Participants (cross-referenced by REQ-DE-15). Verifier implementations SHALL use this identifier to retrieve the public key and validate the signature; if the key cannot be resolved or is no longer trusted, the verifier SHALL treat the certificate as non-authentic. Coding: ICVP.Core #ICVP.D5.DE.26. Carried in HCERT envelope (COSE kid header)."
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.derivedFrom",
      "valueString" : "WHO Coexistence Table 2 ('Integrity Check')"
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Version (ICVP.D5.DE.27 → ICVPMin.v)"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
