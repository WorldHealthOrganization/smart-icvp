...
| Active as of 2026-09-23 | *Computable Name*:Composition-uv-ips-ICVP |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.icvp|current/StructureDefinition/StructureDefinition-Composition-uv-ips-ICVP.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://smart.who.int/icvp/StructureDefinition/Immunization-uv-ips-ICVP"]
      }]
    },
    {
