...
| [ICVP HCERT Payload](StructureDefinition-ICVPMin.md) | Minimal DVC payload for use within an HCERT Payload using the ICVP Product Catalogue |
| [ICVP HCERT Payload](StructureDefinition-ICVPMinVaccineDetails.md) | Minimal vaccine detail in DVC payload for use within an HCERT Payload using the ICVP Product Catalogue |
