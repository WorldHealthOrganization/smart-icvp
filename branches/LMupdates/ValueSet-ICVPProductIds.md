...
| Active as of 2026-04-16 | *Computable Name*:ICVPProductIds |
...
##### WHO ICVP Vaccine Product Ids Schema API
...
### GET /ValueSet-ICVPProductIds.schema.json

#### JSON Schema definition for the enumeration ValueSet-ICVPProductIds

This endpoint serves the JSON Schema definition for the enumeration ValueSet-ICVPProductIds.
