...
```json
{
  ...
  },
  {
    ...
    "text" : {
      "status" : "generated",
      "div" : "<div xml:lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\" lang=\"en\"><p class=\"res-header-id\"><b>Generated Narrative: ValueSet v2-0001</b></p><a name=\"v2-0001\"> </a><a name=\"hcv2-0001\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\">Language: en</p></div><ul><li>Include all codes defined in <a href=\"CodeSystem-v2-0001.html\"><code>http://terminology.hl7.org/CodeSystem/v2-0001</code></a><span title=\"Version is not explicitly stated, which means it is fixed to the version provided in this specification\"> version &#x1F4E6;3.0.0</span></li></ul></div>"
    },
    "url" : "http://terminology.hl7.org/ValueSet/v2-0001",
    "identifier" : [{
      "system" : "urn:ietf:rfc:3986",
      "value" : "urn:oid:2.16.840.1.113883.21.2"
    }],
    "version" : "3.0.0",
    "name" : "Hl7VSAdministrativeSex",
    "title" : "hl7VS-administrativeSex",
    "status" : "active",
    "experimental" : false,
    "date" : "2019-12-01",
    "publisher" : "Health Level Seven International",
  ...
  },
  {
    ...
    "status" : "draft",
    "date" : "2026-04-16T08:18:25+00:00",
    "publisher" : "WHO",
    "contact" : [{
      "name" : "WHO",
      "telecom" : [{
  ...
  },
  {
    ...
    "required" : false,
    "repeats" : false,
    "answerValueSet" : "http://terminology.hl7.org/ValueSet/v2-0203|3.0.0"
  },
  {
    "linkId" : "nid",
