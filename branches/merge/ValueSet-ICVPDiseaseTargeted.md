...
| Active as of 2026-02-18 | *Computable Name*:ICVPDiseaseTargeted |
...
##### ICVP Disease Targeted Schema API
...
### GET /ValueSet-ICVPDiseaseTargeted.schema.json

#### JSON Schema definition for the enumeration ValueSet-ICVPDiseaseTargeted

This endpoint serves the JSON Schema definition for the enumeration ValueSet-ICVPDiseaseTargeted.
