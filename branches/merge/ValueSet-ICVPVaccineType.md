...
| Active as of 2026-02-18 | *Computable Name*:ICVPVaccineType |
...
##### Vaccine Types for use in the ICVP Schema API
...
### GET /ValueSet-ICVPVaccineType.schema.json

#### JSON Schema definition for the enumeration ValueSet-ICVPVaccineType

This endpoint serves the JSON Schema definition for the enumeration ValueSet-ICVPVaccineType.
